...
export default function AirComputationCalculator({workspaceCode,token}:Props){
 ...
 return <main className="min-h-screen bg-slate-950 p-4 text-white"><div className="mx-auto max-w-7xl">
  ...
  <section className="mb-5 grid gap-3 md:grid-cols-3"><Result label="Índice propio" value={results.propio}/><Result label="Índice enemigo" value={results.enemigo}/><Result label="Relación propia/enemiga" value={results.ratio}/></section>
